...
<svelte:head>
  <title>Privacy Policy - {appName} | Coach Israël Kayembe.</title>
</svelte:head>

<Container>
  <div class="">
    <h1 class="pt-20 font-bold uppercase">
      Privacy Policy for {appName}
    </h1>

    <p class="mb-4">
      At {appName}, accessible from https://nextgenbuilders.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by {appName}
      and how we use it.
    </p>
    ...
    <p class="mb-4">
      This Privacy Policy applies only to our online ressources and is valid for
      visitors to our website with regards to the information that they shared
      and/or collect in {appName}. This policy is not applicable to any
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">Consent</h2>
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">Information we collect</h2>
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">How we use your information</h2>
    class="mb-4"
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">Log Files</h2>

    <p class="mb-4">
      {appName} follows a standard procedure of using log files. These files log
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">
    ...
    <p class="mb-4">
      ...
      advertisements and links that appear on {appName}, which are sent directly
    ...
    <p class="mb-4">
      Note that {appName} has no access to or control over these cookies that are
      used by third-party advertisers.
    </p>

    <h2 class="mb-4 mt-2 font-bold uppercase">Third Party Privacy Policies</h2>

    <p class="mb-4">
      {appName}'s Privacy Policy does not apply to other advertisers or
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">GDPR Data Protection Rights</h2>
    ...
    <h2 class="mb-4 mt-2 font-bold uppercase">Children's Information</h2>
    ...
    <p class="mb-4">
      {appName} does not knowingly collect any Personal Identifiable Information
